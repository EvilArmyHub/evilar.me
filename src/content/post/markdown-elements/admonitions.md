...
Чтобы использовать admonitions в evilarme, оберните Markdown-контент в блок с тройными двоеточиями `:::`. В первой строке также нужно указать тип блока.
...
::github{repo="EvilArmyHub/evilar.me"}
